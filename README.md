...
<div align="center">
  <img src="assets/pintra.ico" width="96" height="96" alt="Pintra" />
  <h1>Pintra</h1>
...
SHA-256 для `Pintra-Setup-1.0.4-win-x64.exe`:

```text
23ABA225F77926B58729BB9B5C28F87877CD351BED69909BBE89863087A14B45
```
...
1. Download `Pintra-Setup-1.0.4-win-x64.exe`.
...
- Keep selected windows always on top.
- Click-through mode with emergency control recovery.
- Configurable global keyboard shortcuts.
- Application profiles with dedicated shortcuts.
- Window opacity, placement, and position locking.
...
SHA-256 for `Pintra-Setup-1.0.4-win-x64.exe`:
